...
export default function EditPrayerScreen() {
  ...
  const dayLettersParam = Array.isArray(params.days) ? params.days[0] : params.days;
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.formCard}>
          ...
          <View style={styles.dayRow}>
            {dayStates.map((day) => (
              <Pressable key={day.id} style={[styles.dayPill, day.active && styles.dayPillActive]} onPress={() => toggleDay(day.id)}>
...
function safeParseArray(serialized?: string) {
